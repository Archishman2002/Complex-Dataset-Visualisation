...
path="/rainfall_area-wt_India_1901-2015.csv"
df = pd.read_csv(path)

numerical_columns = df.select_dtypes(include="number").columns

pie_column = numerical_columns[1] # or any other column you want
pie_df = df.groupby(pie_column).sum()
pie_labels = pie_df.index
pie_values = pie_df.iloc[:, 1] # or any other column you want
plt.pie(pie_values, labels=pie_labels, autopct="%1.1f%%")
plt.title(f"Pie chart for {pie_column}")
plt.show()

bar_column_x = numerical_columns[1] # or any other column you want
...
line_column = numerical_columns[1] # or any other column you want
...
scatter_column_y = numerical_columns[1] # or any other column you want
...
hist_column = numerical_columns[1] # or any other column you want
